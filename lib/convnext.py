...
class CamouflageDetectionNet(nn.Module):
    def __init__(self, features=[96, 192, 384, 768], pretrained=True):
        super().__init__()
        ...
        convnext_channels = self.backbone.out_channels  # [96, 192, 384, 768]

        self.encoder1 = MambaConvBlock(convnext_channels[0], features[0])
        self.encoder2 = MambaConvBlock(convnext_channels[1], features[1])
        self.encoder3 = MambaConvBlock(convnext_channels[2], features[2])
        self.encoder4 = MambaConvBlock(convnext_channels[3], features[3])
        ...
        ##self.encoder1 = MambaConvBlock(pvt_channels[0], features[0])
        #self.encoder2 = MambaConvBlock(pvt_channels[1], features[1])
        ##self.encoder3 = MambaConvBlock(pvt_channels[2], features[2])
        #self.encoder4 = MambaConvBlock(pvt_channels[3], features[3]) # Bottleneck
